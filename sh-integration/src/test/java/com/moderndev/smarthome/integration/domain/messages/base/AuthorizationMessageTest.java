...
//import com.moderndev.smarthome.integration.messages.Message;
//import com.moderndev.smarthome.integration.messages.IntegrationResultJsonObject;
//import com.moderndev.smarthome.integration.domain.message.IntegrationRequestParseException;
...
//        }catch(IntegrationRequestParseException ex){
...
//        assertThrows(IntegrationRequestParseException.class, () -> {
//            String request = "";
//            PowerMockito.doCallRealMethod()
//                .when(this.authorizationMessage)
//                .parse(request);
